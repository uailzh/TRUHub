...
?>
  ...
  <header class='header'>
    ...
    <nav class='navbar'>
      ...
      <a href='#' class='current' id='aboutLink'>About</a>
    </nav>
  </header>

  <div class="intro"  data-aos="fade-left" data-aos-duration="2000" data-aos-once="true">
  </div>
  
  <div class="container" data-aos="fade-left" data-aos-duration="2000" data-aos-once="true">
  <img src='img/about2.svg' style="width: 100%;">
  </div>


  <form id='rateP' action='controllerTRU.php' method='get' style='display: none;'>
    <input type='hidden' name='page' value='AboutPage'>
