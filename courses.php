...
<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Epilogue:wght@400&family=Finger+Paint&display=swap">
  ...
  <style>
    ...
    * {
    ...
    .search-button,
    .help-center-button {
      margin-bottom: 20px; /* Add margin to separate the buttons */
    ...
    .search-button,
    .help-center-button {
      background-color: #FF6F61; /* Your preferred color for the first button */
      color: white;
      padding: 20px 40px;
      border-radius: 30px;
    ...
    .help-center-button {
      background-color: #4CAF50; /* Your preferred color for the second button */
    }

    .search-button:hover{
      background-color: #D5564A; /* Your preferred hover color */
    }
    ...
    .help-button {
      ...
      bottom: 40%;
      left: 37%;
      background-color: #D24F8D; /* Your preferred color */
      color: white;
      padding: 10px 30px;
      border-radius: 20px;
      text-decoration: none;
...
?>
  ...
  <header class='header'>
    ...
    <nav class='navbar'>
      ...
      <a href='#' class='current' id='coursesLink'>Courses</a>
   ...
   <form id='rateP' action='controllerTRU.php' method='get' style='display: none;'>
    <input type='hidden' name='page' value='CoursesPage'>
    ...
    <form id='comp2' action='controllerTRU.php' method='get' style='display: none;'>
    <input type='hidden' name='page' value='CoursesPage'>
    <input type='hidden' name='command' value='Comp2'>
    </form>
    
    <form id='comp3' action='controllerTRU.php' method='get' style='display: none;'>
    <input type='hidden' name='page' value='CoursesPage'>
    <input type='hidden' name='command' value='Comp3'>
    </form>
    
    
    <form id='compDepartment' action='controllerTRU.php' method='get' style='display: none;'>
    <input type='hidden' name='page' value='CoursesPage'>
    <input type='hidden' name='command' value='CompDep'>
    </form>
...
<button id="chat-button">
 ...
 <div class='buttons' style='margin-right: 3%;'>
    <a href="#" class="search-button" onclick="scrollToNextSection()">Search Courses</a>
    <a href="#" class="help-center-button" onclick="scrollToNextSection2()">Help Center</a>
  </div>
  </div>



<div class="next" id="searchSection" style="background: url('img/search.png'); display: flex; justify-content: flex-start; align-items: center; width: 100%; height: 100vh; position: relative;" data-aos="fade-in" data-aos-duration="2000" data-aos-once="true">
  <div class="Card">
    <div class="CardInner">
      <div class="container">
        <div class="Icon">
  ...
  <a href="#" id="class2" style="display: none;">COMP 4610</a>
  <a href="#" id="class3" style="display: none;">COMP 3260</a>
</div>
</div>
...
<div class="parent">
  ...
  <div class="container4" data-aos="fade-left" data-aos-duration="1500" data-aos-once="true">

    <div class="cardings4">
      <img src='img/1.svg'>
      <div class="overlay-text4">Computer Science</div>
    </div>
    <div class="cardings4">
      <img src='img/2.svg'>
      <div class="overlay-text4">Science</div>
    </div>
    <div class="cardings4">
      <img src='img/3.svg'>
      <div class="overlay-text4">Arts</div>
    </div>
  ...
  <div class="container4"  data-aos="fade-left" data-aos-duration="1500" data-aos-once="true">
    <div class="cardings4">
      <img src='img/4.svg'>
      <div class="overlay-text4">Tourism</div>
    </div>
    <div class="cardings4">
      <img src='img/5.svg'>
      <div class="overlay-text4">Business</div>
    </div>
    <div class="cardings4">
     <img src='img/6.svg'>
      <div class="overlay-text4">Culinary Arts</div>
    </div>
  </div>
  </div>


 <div class="help" style="position: relative;" id="helpSection" data-aos="fade-in" data-aos-duration="2000" data-aos-once="true">
 <a href="#" class="help-button" id='forumBut'>
  Help Center
</a>
  ...
  const cardings4Elements = document.querySelectorAll('.cardings4');

    // Loop through each element and attach a click event listener
    cardings4Elements.forEach(element => {
      // Add click event listener
      element.addEventListener('click', function() {
        
        // Submit the form
        document.getElementById('compDepartment').submit();
      });
    });
 ...
 function searchClasses() {
  var searchValue = document.getElementById('classesInput').value.trim().toLowerCase();
...
function performClassSearch(searchValue) {
  ...
  if (searchValue === "comp" || searchValue === "3020" || searchValue === "comp 3020" || searchValue === "comp3020" || searchValue === "web" || searchValue === "design" || searchValue === "web design" ) {
  ...
  else if (searchValue === "comp" || searchValue === "4610" || searchValue === "comp 4610" || searchValue === "comp4610" || searchValue === "ai" || searchValue === "artificial" || searchValue === "intelligence" || searchValue === "artificial intelligence") {
    document.getElementById('classes').style.display = 'block';
  ...
  else if (searchValue === "comp" || searchValue === "3260" || searchValue === "comp 3260" || searchValue == "comp3260" || searchValue === "data" || searchValue === "database" || searchValue === "databasemanagement") {
    document.getElementById('classes').style.display = 'block';
   ...
   document.getElementById('rateProf').addEventListener('click', function() {
     ...
     document.getElementById('forumBut').addEventListener('click', function() {
    ...
    document.getElementById('class2').addEventListener('click', function() {
        document.getElementById('comp2').submit();
    });
    
    document.getElementById('class3').addEventListener('click', function() {
        document.getElementById('comp3').submit();
    });
  ...
  function scrollToNextSection() {
    ...
    var nextSection = document.getElementById('searchSection');
...
function scrollToNextSection2() {
    // Get the element with the specified id
    var nextSection = document.getElementById('helpSection');
