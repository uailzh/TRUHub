...
<head>
  ...
  <style>
    * {
    ...
    .intro {
      background-image: url('img/prof2.svg');
...
<div class="offer" id="offer" data-aos="fade-right" data-aos-duration="2000" data-aos-once="true">
    ...
    <div class="tags-feedback-container">
        <div class="tags-container">
            ...
            <div style="margin-top: 5%;">
                ...
                <div class="tag">RESPECTED</div>
                <div class="tag">CLEAR GRADING CRITERIA</div>
                <div class="tag">TEST HEAVY</div>
                <div class="tag">LOTS OF HOMEWORK</div>
                <div class="tag">CARING</div>
            </div>
        </div>
        ...
        <div class="feedback-container">
            ...
            <p style="text-align: center; margin-bottom: 3%;">
                <strong>COMP 1140</strong><br></p>
             <p style="margin-bottom: 4%;">   Attendance: Mandatory | Would Take Again: Yes | Grade: B- | Textbook: No
            </p>

            <p style="margin-bottom: 4%;">Kate is a good professor, however I felt like the class material was extremely hard. She was always available outside of class, but I was still struggling. Overall good professor, but be ready to study hard for Java 1140!.</p>

		<div style="margin-bottom: 5%;">
            <div class="tag" style="background: #E39E21;">CARING</div>
            <div class="tag" style="background: #E39E21;">TEST HEAVY</div>
    ...
    <span id="like-count" style="margin-right: 3%;">4</span>
    ...
    <span id="dislike-count">0</span>
        ...
        <div class="feedback-container" style="margin-top: 3%;">
            ...
            <p style="text-align: center; margin-bottom: 3%;">
                <strong>COMP 2120</strong><br></p>
             <p style="margin-bottom: 4%;">   Attendance: Mandatory | Would Take Again: Yes | Grade: A+ | Textbook: No
            </p>

            <p style="margin-bottom: 4%;">Great class and wonderful professor! I had a great time learning about Android Development, but it would be nice if she could switch from tests to projects. Did not really have much of experience of developing my own thing. </p>

		<div style="margin-bottom: 5%;">
            <div class="tag" style="background: #E39E21;">HELPFUL</div>
            <div class="tag" style="background: #E39E21;">LOTS OF HOMEWORK</div>
    ...
    <span id="dislike-count2">2</span>
     ...
     <div class="feedback-container" style="margin-top: 3%;">
            ...
            <p style="text-align: center; margin-bottom: 3%;">
                <strong>COMP 4120</strong><br></p>
             <p style="margin-bottom: 4%;">   Attendance: Mandatory | Would Take Again: Yes | Grade: C+ | Textbook: Yes
            </p>

            <p style="margin-bottom: 4%;"> I did not like the class. Cyber security seemed like an interesting thing to learn at first but then it was very boring. Did not have any motivation to study. Moreover, I did not feel like she was good at explaining material.</p>
    ...
    <span id="like-count" style="margin-right: 3%;">3</span>
    <span class="thumb" onclick="updateThumbs('down')">
        <i class="fas fa-thumbs-down"></i>
    </span>
