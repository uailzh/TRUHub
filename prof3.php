...
<head>
  ...
  <style>
    * {
    ...
    .intro {
      background-image: url('img/prof3.svg');
...
<div class="offer" id="offer" data-aos="fade-right" data-aos-duration="2000" data-aos-once="true">
    ...
    <div class="tags-container">
        ...
        <div style="margin-top: 5%;">
            ...
            <div class="tag">APPROACHABLE</div>
            <div class="tag">ENGAGING</div>
            <div class="tag">FAIR GRADER</div>
            <div class="tag">ORGANIZED</div>
            <div class="tag">RESPONSIVE</div>
            <div class="tag">EFFECTIVE COMMUNICATOR</div>
            <div class="tag">ENCOURAGING</div>
        </div>
    </div>
        ...
        <div class="feedback-container">
            ...
            <p style="text-align: center; margin-bottom: 3%;">
             ...
             <p style="margin-bottom: 4%;">   Attendance: Voluntary | Would Take Again: Yes | Grade: B- | Textbook: No
            </p>

            <p style="margin-bottom: 4%;">I love his lectures! Although it is 3 hours, it was very interesting and fast paced. I love Joooohn!!!</p>

		<div style="margin-bottom: 5%;">
            <div class="tag" style="background: #E39E21;">CARING</div>
            <div class="tag" style="background: #E39E21;">ORGANIZED</div>
            <div class="tag" style="background: #E39E21;">ENGAGING</div>
    ...
    <span id="like-count" style="margin-right: 3%;">8</span>
    ...
    <span id="dislike-count">1</span>
        ...
        <div class="feedback-container" style="margin-top: 3%;">
            ...
            <p style="text-align: center; margin-bottom: 3%;">
                <strong>COMP 3020</strong><br></p>
             <p style="margin-bottom: 4%;">   Attendance: Volunatry | Would Take Again: Yes | Grade: A+ | Textbook: No
            </p>

            <p style="margin-bottom: 4%;">Professor John's Web Design 3020 course was fantastic! His teaching style is engaging, and he provides clear explanations. I appreciated his hands-on approach, which helped me understand complex concepts easily. Highly recommend taking his class! </p>

		<div style="margin-bottom: 5%;">
            <div class="tag" style="background: #E39E21;">HELPFUL</div>
            <div class="tag" style="background: #E39E21;">FAIR GRADER</div>
    ...
    <span id="like-count2" style="margin-right: 3%;">5</span>
    <span class="thumb" onclick="updateThumbs2('down')">
        <i class="fas fa-thumbs-down"></i>
    </span>
    <span id="dislike-count2">2</span>
</div>
     ...
     <div class="feedback-container" style="margin-top: 3%;">
            ...
            <p style="text-align: center; margin-bottom: 3%;">
                <strong>COMP 4610</strong><br></p>
             <p style="margin-bottom: 4%;">   Attendance: Mandatory | Would Take Again: Yes | Grade: C+ | Textbook: Yes
            </p>

            <p style="margin-bottom: 4%;"> Professor John's Artificial Intelligence class was insightful and engaging. He brings real-world examples into the classroom, making the material easy to grasp. Highly recommended for anyone interested in AI!</p>

		<div style="margin-bottom: 5%;">
            <div class="tag" style="background: #E39E21;">TOUGH GRADER</div>
            <div class="tag" style="background: #E39E21;">KNOWLEDGABLE</div>
             <div class="tag" style="background: #E39E21;">ENGAGING</div>
